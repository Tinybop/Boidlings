...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[SimpleAudioEngine sharedEngine] preloadEffect:@"enemy-bump.wav"];

    // Load up collision sounds
    [[CollisionSounds sharedSounds] addCollisionSoundForFirstType:kEnemyCollisionType secondType:kEnemyCollisionType soundFile:@"enemy-bump.wav"];
